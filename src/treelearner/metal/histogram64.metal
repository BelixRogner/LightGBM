// 64-bin gradient/hessian histogram kernel for Apple Metal.
//
// Same shape as histogram256.metal but with NUM_BINS=64. Used for features
// with bin count in (16, 64]. Threadgroup memory footprint is smaller, which
// can allow higher NUM_SUBHIST settings on contention-heavy workloads.
