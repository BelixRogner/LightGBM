// 16-bin gradient/hessian histogram kernel for Apple Metal.
//
// Same shape as histogram256.metal but with NUM_BINS=16. The very small
// threadgroup memory footprint lets us use a higher NUM_SUBHIST (one per
// thread in the worst case) for near-zero atomic contention.
